...
- **Municipal de Pouso Alegre:** abre uma janela temporária do Edge porque o portal bloqueia o navegador invisível, escolhe emissão por CPF/CNPJ, preenche CNPJ e finalidade, obtém o PDF e fecha a janela sozinha. Confere prefeitura, tipo negativo, CNPJ, nome, número, controle, emissão e validade antes de liberar o download. Não exige clique nessa janela.
...
| Pouso Alegre           | **CND e PDF obtidos automaticamente para FUVS, 23.951.916/0001-22, sem login nem intervenção no teste real de 10/09/2026. Número 64217/2026; validade: 09/12/2026.** Abre Edge visível para o CAPTCHA automático do portal. |
...
Ao final, os **36 testes controlados** e os testes de interface passaram, incluindo os cinco casos específicos de Pouso Alegre.
