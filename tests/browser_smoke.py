...
def main():
    ...
    try:
        with sync_playwright() as playwright:
            ...
            expect(page.get_by_role('link',name='Baixar certidão em PDF')).to_have_count(4)
        ...
        print('OK: fluxos federal, FGTS, CNDT e Santa Rita, PDF, escape HTML, recuperação e layout móvel. Retornos simulados.')
    finally:
